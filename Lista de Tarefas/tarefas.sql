...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14/11/2023 às 21:54
...
--
CREATE DATABASE IF NOT EXISTS `bd_lista` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `bd_lista`;
...
INSERT INTO `tarefas_concluidas` (`id_tarefasc`, `nome_tarefa`, `cod_statusf`, `prazo`, `entrega`, `cod_usuariof`) VALUES
(2, 'TPA1', 4, '2023-11-21', '2023-11-13', 1),
(3, 'add', 4, '2023-11-27', '2023-11-13', 1),
(4, 'atrasado', 5, '2023-11-09', '2023-11-13', 1),
(5, 'atrasado2', 4, '2023-11-03', '2023-11-13', 1),
(6, 'atrasado3', 5, '2023-10-19', '2023-11-13', 1),
(7, 'hora', 4, '2023-11-28', '2023-11-13', 1),
(8, 'menos', 5, '2023-11-08', '2023-11-13', 1);
...
--
ALTER TABLE `tarefas_concluidas`
  MODIFY `id_tarefasc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
('root', '[{\"db\":\"bd_lista\",\"table\":\"tarefas_concluidas\"},{\"db\":\"bd_lista\",\"table\":\"usuarios\"},{\"db\":\"bd_lista\",\"table\":\"tarefas\"},{\"db\":\"bd_lista\",\"table\":\"status\"},{\"db\":\"tb_lista\",\"table\":\"usuarios\"},{\"db\":\"tb_lista\",\"table\":\"comentario\"},{\"db\":\"tb_lista\",\"table\":\"tarefas\"},{\"db\":\"lista\",\"table\":\"comentario\"},{\"db\":\"lista\",\"table\":\"prioridade\"},{\"db\":\"lista\",\"table\":\"status\"}]');
...
('root', '2023-11-01 19:47:23', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt_BR\"}');
